...
def evaluate_paths(bfs_result: AutoFeat, problem_type: str, algorithm: str, join_paths_df: pd.DataFrame, lake_data_folder: str, lake_table_sep: str, base_table_sep: str, top_k_paths: int = 15) -> Tuple[List, List[Tuple]]:
