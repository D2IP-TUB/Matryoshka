...
if __name__ == "__main__":
    ...
    corr_choices = {
        'classification': [0.001, 0.01, 0.05, 0.1, 0.3, 0.5],
        'regression': [0.05, 0.3, 0.55, 0.75, 0.9]
    }
        ...
        for corr_threshold in corr_choices[corr_task]:
            for lake, config in config_df_copy.group_by('lake'):
                ...
                for row in config.iter_rows():
                    ...
                    combination_hash = f'{lake}_{base_table_name}_{task}_{corr_threshold}'
                    ...
                    find_best_joins_kwargs = {'user_table_processed': X, 'top_k': 50, 'n_jobs': 32, 'config': config}
    ...
    experiment_dir = 'experiments/downstream/ablation/top_k/logs/'
