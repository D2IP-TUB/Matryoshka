        ...
        match task:
            case 'regression':
                ...
                while (not early_stopping) and (new_features_count > 0):
                    ...
                    remaining_features, statistics = ray.get(sketch_proc._update_cache_and_get_stats.remote(task))
            ...
            case 'classification':
                ...
                while (not early_stopping) and (new_features_count > 0):
                    ...
                    update_futures = [
                        sketch_proc_per_class[label]._update_cache_and_get_stats.remote(task)
                        for label in sketch_proc_per_class
                    ]
