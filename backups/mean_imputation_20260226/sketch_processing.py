...
def _impute_sketch_table_pure(user_table_agg, sketch_table, query_column_name):
...
def _create_aug_table_sketch_task(group, user_table_agg, query_column_name,
    ...
    if table.height < user_table_agg.height:
        table, padding, padded_cofactors = _impute_sketch_table_pure(user_table_agg, table, query_column_name)
